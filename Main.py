...
print('Worst time correlation', np.corrcoef(GraphStuff, list(worstTimefindMin.values()))[0, 1])
print('Median time correlation', np.corrcoef(GraphStuff, list(worstTimefindMax.values()))[0, 1])
